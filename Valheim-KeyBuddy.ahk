...
KeyBuddy_Version = 0.25 ;Used for display in application
; KeyBuddyThisVersionNote=A new version of KeyBuddy (0.25) is available. Also found at
...
version := "0.25", company := "Wrongtown"    ; Keep these lines together
