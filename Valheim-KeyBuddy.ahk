...
KeyBuddy_Version = 0.24 ;Used for display in application
; KeyBuddyThisVersionNote=A new version of KeyBuddy (0.24) is available. Also found at
...
version := "0.24", company := "Wrongtown"    ; Keep these lines together
