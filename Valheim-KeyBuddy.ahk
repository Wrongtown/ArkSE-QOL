...
KeyBuddy_Version = 0.23 ;Used for display in application
; KeyBuddyThisVersionNote=A new version of KeyBuddy (0.23) is available. Also found at
...
version := "0.23", company := "Wrongtown"    ; Keep these lines together
